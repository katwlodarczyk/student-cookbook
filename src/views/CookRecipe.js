  ...
  return (
    <div className="relative text-gray-700 w-full min-h-screen h-max">
        ...
        <div className="mb-44 p-4 flex flex-col space-y-5">
            ...
            <img className="absolute z-0 bottom-56 w-2/3 mx-auto flex-none inset-x-0 opacity-30" src={bowl} alt="bowl" />
        </div>
        { loading ? 
        (
            ...
            <Link onClick={updateState} to={currentStep < steps ? `/recipe/${recipeId}/step/${nextStep}` : `/`} className="fixed bottom-28 w-full py-6 bg-brand-orange text-white tracking-wide font-semibold text-xl flex flex-row justify-center items-center space-x-6">
