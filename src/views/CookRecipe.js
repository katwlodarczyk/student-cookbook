  ...
  return (
    <div className="relative text-gray-700 w-full min-h-screen h-max">
        ...
        (
            ...
            <Link onClick={updateState} to={currentStep < steps ? `/recipe/${recipeId}/step/${nextStep}` : `/`} className="fixed bottom-24 w-full py-6 bg-brand-orange text-white tracking-wide font-semibold text-xl flex flex-row justify-center items-center space-x-6">
