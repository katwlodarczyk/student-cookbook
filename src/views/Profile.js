...
const Profile = (props) => {
  ...
  return (
    <div className="w-full min-h-screen h-max">
        ...
        <div onClick={signOut} className="fixed bottom-24 w-full py-6 bg-red-500 text-white tracking-wide font-semibold text-xl flex flex-row justify-center items-center space-x-6">
            <span>SIGN OUT</span>
